...
const pricingWrapperStyles=(0,clsx_m/* default */.Z)`w-full h-[600px] relative z-10 flex flex-col justify-center items-center bg-perfect-bgMainFilter`;const pricingBackgroundImageStyles=(0,clsx_m/* default */.Z)`absolute-important top-0 left-0 w-full z-0 h-[600px]`;const pricingTitleStyles=(0,clsx_m/* default */.Z)`text-[30px] text-[#fff] font-bold`;const pricingTableStyles=(0,clsx_m/* default */.Z)`bg-[#e3e1f9cc] rounded-[4px] mt-8 w-[80vw] md:w-[60vw] lg:w-[50vw]`;const pricingTableHeadStyles=(0,clsx_m/* default */.Z)`
text-[#fff]
