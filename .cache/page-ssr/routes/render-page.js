...
var React = _interopRequireWildcard(__webpack_require__(8534));
...
var _scrollHandler = __webpack_require__(1432);
var _react = __webpack_require__(8534);
...
var _react = _interopRequireDefault(__webpack_require__(8534));
...
exports.components={"component---src-pages-404-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-404-tsx */ 218).then(__webpack_require__.bind(__webpack_require__, 2513)),"component---src-pages-index-tsx":()=>Promise.all(/* import() | component---src-pages-index-tsx */[__webpack_require__.e(994), __webpack_require__.e(691)]).then(__webpack_require__.bind(__webpack_require__, 4740))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-sitemap',plugin:__webpack_require__(4988),options:{"plugins":[],"output":"/","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]}},{name:'gatsby-plugin-breakpoints',plugin:__webpack_require__(7755),options:{"plugins":[],"queries":{"xs":"(max-width: 320px)","sm":"(max-width: 768px)","md":"(max-width: 1024px)","l":"(max-width: 1536px)"}}},{name:'gatsby-plugin-dark-mode',plugin:__webpack_require__(8632),options:{"plugins":[]}},{name:'gatsby-plugin-use-dark-mode',plugin:__webpack_require__(4544),options:{"plugins":[],"classNameDark":"dark-mode","classNameLight":"light-mode","storageKey":"darkMode","minify":true}},{name:'@tmttn/gatsby-plugin-hubspot-tracking',plugin:__webpack_require__(6681),options:{"plugins":[],"trackingCode":"21824221","respectDNT":false,"productionOnly":false}},{name:'gatsby-plugin-image',plugin:__webpack_require__(2588),options:{"plugins":[]}},{name:'partytown',plugin:__webpack_require__(5292),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
const trimmedPathname=stripPrefix(pathname,decodeURIComponent("/perfectTychy"))// Remove any hashfragment
...
if(this.staticQueryDb[staticQueryHash]){const jsonPayload=this.staticQueryDb[staticQueryHash];return{staticQueryHash,jsonPayload};}return this.memoizedGet(`${"/perfectTychy"}/page-data/sq/d/${staticQueryHash}.json`).then(req=>{const jsonPayload=JSON.parse(req.responseText);return{staticQueryHash,jsonPayload};}).catch(()=>{throw new Error(`We couldn't load "${"/perfectTychy"}/page-data/sq/d/${staticQueryHash}.json"`);});})).then(staticQueryResults=>{const staticQueryResultsMap={};staticQueryResults.forEach(({staticQueryHash,jsonPayload})=>{staticQueryResultsMap[staticQueryHash]=jsonPayload;this.staticQueryDb[staticQueryHash]=jsonPayload;});return staticQueryResultsMap;});return Promise.all([componentChunkPromises,staticQueryBatchPromise]).then(([pageResources,staticQueryResults])=>{let payload;if(pageResources){payload={...pageResources,staticQueryResults};finalResult.payload=payload;emitter.emit(`onPostLoadPageResources`,{page:payload,pageResources:payload});}this.pageDb.set(pagePath,finalResult);if(finalResult.error){return{error:finalResult.error,status:finalResult.status};}return payload;})// when static-query fail to load we throw a better error
...
const React=__webpack_require__(8534);const{grabMatchParams}=__webpack_require__(9755);const{StaticQueryContext}=__webpack_require__(7076);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9706);const{ServerLocation,Router}=__webpack_require__(7896);const{renderToString}=__webpack_require__(18);const{parse}=__webpack_require__(698);const styleToOjbect=__webpack_require__(7848);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
exports.__esModule=true;exports["default"]=void 0;var _default={respectDNT:false,productionOnly:true};exports["default"]=_default;
...
"use strict";
var _interopRequireDefault=__webpack_require__(4836);exports.__esModule=true;exports.onRenderBody=onRenderBody;var _taggedTemplateLiteralLoose2=_interopRequireDefault(__webpack_require__(9452));var _react=_interopRequireDefault(__webpack_require__(8534));var _utils=__webpack_require__(706);var _defaultOptions=_interopRequireDefault(__webpack_require__(9065));var _templateObject;function onRenderBody(_ref,pluginOptions){var setPostBodyComponents=_ref.setPostBodyComponents;var _Object$assign=Object.assign({},_defaultOptions.default,pluginOptions),productionOnly=_Object$assign.productionOnly,respectDNT=_Object$assign.respectDNT,trackingCode=_Object$assign.trackingCode,region=_Object$assign.region;if(productionOnly&&"production"!=="production"||!(0,_utils.isDefined)(trackingCode)){return;}setPostBodyComponents([/*#__PURE__*/_react.default.createElement("script",{type:"text/javascript",id:"hs-script-loader",key:"@tmttn/gatsby-plugin-hubspot-tracking",async:true,defer:true,src:"//js"+(region?"-"+region:"")+".hs-scripts.com/"+trackingCode+".js",dangerouslySetInnerHTML:{__html:(0,_utils.oneline)(_templateObject||(_templateObject=(0,_taggedTemplateLiteralLoose2.default)(["\n                    var _hsq = window._hsq = window._hsq || [];\n                    _hsq.push(['setPath', window.location.pathname + window.location.search + window.location.hash]);\n                    ","\n                    \n                "])),respectDNT?"if (window.doNotTrack || navigator.doNotTrack || navigator.msDoNotTrack || 'msTrackingProtectionEnabled' in window.external) {\n                        if (window.doNotTrack == \"1\" || navigator.doNotTrack == \"yes\" || navigator.doNotTrack == \"1\" || navigator.msDoNotTrack == \"1\" || window.external.msTrackingProtectionEnabled()) {\n                            _hsq.push(['doNotTrack']);\n                        }\n                    }":"")}})]);}
...
"use strict";
exports.__esModule=true;exports.oneline=exports.isDefined=void 0;var oneline=function oneline(){var out='';for(var _len=arguments.length,args=new Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}for(var i=0;i<args.length;i++){if(Array.isArray(args[i])){out+=args[i].join('');}else{out+=args[i];}}return out.replace(/\s\s+/g,'');};exports.oneline=oneline;var isDefined=function isDefined(val){return typeof val!=='undefined'&&val!==null;};exports.isDefined=isDefined;
...
"use strict";
var _interopRequireDefault=__webpack_require__(4836);exports.__esModule=true;exports.BreakpointProvider=exports.BreakpointContext=void 0;exports.useBreakpoint=useBreakpoint;var _propTypes=_interopRequireDefault(__webpack_require__(5697));var _react=_interopRequireWildcard(__webpack_require__(8534));function _getRequireWildcardCache(e){if("function"!=typeof WeakMap)return null;var r=new WeakMap(),t=new WeakMap();return(_getRequireWildcardCache=function(e){return e?t:r;})(e);}function _interopRequireWildcard(e,r){if(!r&&e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var t=_getRequireWildcardCache(r);if(t&&t.has(e))return t.get(e);var n={__proto__:null},a=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var u in e)if("default"!==u&&Object.prototype.hasOwnProperty.call(e,u)){var i=a?Object.getOwnPropertyDescriptor(e,u):null;i&&(i.get||i.set)?Object.defineProperty(n,u,i):n[u]=e[u];}return n.default=e,t&&t.set(e,n),n;}const defaultValue={};const BreakpointContext=exports.BreakpointContext=/*#__PURE__*/(0,_react.createContext)(defaultValue);const BreakpointProvider=({children,queries})=>{const[queryMatch,setQueryMatch]=(0,_react.useState)({});(0,_react.useEffect)(()=>{const mediaQueryLists={};const keys=Object.keys(queries);let isAttached=false;const handleQueryListener=()=>{const updatedMatches=keys.reduce((acc,media)=>{acc[media]=!!(mediaQueryLists[media]&&mediaQueryLists[media].matches);return acc;},{});setQueryMatch(updatedMatches);};if(window&&window.matchMedia){const matches={};keys.forEach(media=>{if(typeof queries[media]==='string'){mediaQueryLists[media]=window.matchMedia(queries[media]);matches[media]=mediaQueryLists[media].matches;}else{matches[media]=false;}});setQueryMatch(matches);isAttached=true;keys.forEach(media=>{if(typeof queries[media]==='string'){mediaQueryLists[media].addListener(handleQueryListener);}});}return()=>{if(isAttached){keys.forEach(media=>{if(typeof queries[media]==='string'){mediaQueryLists[media].removeListener(handleQueryListener);}});}};},[queries]);return/*#__PURE__*/_react.default.createElement(BreakpointContext.Provider,{value:queryMatch},children);};exports.BreakpointProvider=BreakpointProvider;BreakpointProvider.propTypes={children:_propTypes.default.element.isRequired,queries:_propTypes.default.object.isRequired};function useBreakpoint(){const context=(0,_react.useContext)(BreakpointContext);if(context===defaultValue){throw new Error('useBreakpoint must be used within BreakpointProvider');}return context;}
...
"use strict";
exports.__esModule=true;exports.defaultQueries=void 0;const defaultQueries=exports.defaultQueries={xs:'(max-width: 320px)',sm:'(max-width: 720px)',md:'(max-width: 1024px)',l:'(max-width: 1536px)'};
...
"use strict";
var _interopRequireDefault=__webpack_require__(4836);exports.__esModule=true;exports.wrapRootElement=void 0;var _react=_interopRequireDefault(__webpack_require__(8534));var _constants=__webpack_require__(2615);var _BreakpointProvider=__webpack_require__(929);// eslint-disable-next-line no-unused-vars
const wrapRootElement=({element},{queries=null})=>{return/*#__PURE__*/_react.default.createElement(_BreakpointProvider.BreakpointProvider,{queries:queries!==null?queries:_constants.defaultQueries},element);};exports.wrapRootElement=wrapRootElement;
...
const React=__webpack_require__(8534);exports.onRenderBody=function({setPreBodyComponents}){setPreBodyComponents([React.createElement('script',{key:'gatsby-plugin-dark-mode',dangerouslySetInnerHTML:{__html:`
void function() {
...
"use strict";
var React=_interopRequireWildcard(__webpack_require__(8534));var _gatsby=__webpack_require__(7076);var _path=__webpack_require__(1423);function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: Remove for v3 - Fix janky path/asset prefixing
...
"use strict";
exports.__esModule=true;exports.onRenderBody=void 0;var React=_interopRequireWildcard(__webpack_require__(8534));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}const onRenderBody=({setPreBodyComponents})=>{setPreBodyComponents([/*#__PURE__*/React.createElement("script",{key:"gatsby-plugin-use-dark-mode",id:"gatsby-plugin-use-dark-mode"// eslint-disable-next-line react/no-danger
,dangerouslySetInnerHTML:{// populated in gatsby-node via Webpack's DefinePlugin
__html:String("(function(o,l,t){function c(r){document.body.classList.add(r?o:l);document.body.classList.remove(r?l:o)}var s=\"(prefers-color-scheme: dark)\";var a=window.matchMedia(s);var d=a.media===s;var e=null;try{e=JSON.parse(localStorage.getItem(t))}catch(r){}var i=e===true||e===false;if(i){c(e)}else if(d){c(a.matches);localStorage.setItem(t,a.matches)}else{var m=document.body.classList.contains(o);localStorage.setItem(t,JSON.stringify(m))}})(\"dark-mode\",\"light-mode\",\"darkMode\");")}})]);};exports.onRenderBody=onRenderBody;
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(6464),e=__webpack_require__(8534),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("/Users/krzysztofogaza/Documents/perfectTychy/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/krzysztofogaza/Documents/perfectTychy/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/krzysztofogaza/Documents/perfectTychy/node_modules/react/index.js");
...
const React=__webpack_require__(8534);const path=__webpack_require__(1423);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(18);const{ServerLocation,Router,isRedirect}=__webpack_require__(7896);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(7076);const fs=__webpack_require__(6732);const{WritableAsPromise}=__webpack_require__(5897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(4067);const asyncRequires=__webpack_require__(5418);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(9755);const{headHandlerForSSR}=__webpack_require__(923);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(8995);const{ServerSliceRenderer}=__webpack_require__(7529);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
...
await apiRunnerAsync(`replaceRenderer`,{bodyComponent,replaceBodyHTMLString,setHeadComponents,setHtmlAttributes,setBodyAttributes,setPreBodyComponents,setPostBodyComponents,setBodyProps,pathname:pagePath,pathPrefix:"/perfectTychy"});// If no one stepped up, we'll handle it.
...
if(!isRedirect(e))throw e;}}apiRunner(`onRenderBody`,{setHeadComponents,setHtmlAttributes,setBodyAttributes,setPreBodyComponents,setPostBodyComponents,setBodyProps,pathname:pagePath,loadPageDataSync,bodyHtml,scripts,styles,pathPrefix:"/perfectTychy"});// we want to run Head after onRenderBody, so Html and Body attributes
